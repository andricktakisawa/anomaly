...
<body class="dark-scheme">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex sm-pt10">
                        ...
                        <div class="d-flex-col header-col-mid">
                            <!-- mainmenu begin -->
                            <ul id="mainmenu">
                                <li><a href="#de-carousel"></a></li>
                            </ul>
                            <!-- mainmenu close -->
                        </div>
                        <div class="d-flex-col">
                            <div class="menu_side_area">
                                <a href="index.html" class="btn-main"><i class="fa fa-sign-in"></i><span>Back</span></a>
    ...
    <!-- section begin -->
    <section id="subheader" class="text-light" style="background-image: url(images/background/subheader.jpg); background-position: bottom;">
    ...
    <footer>
        <div class="footer-container" style="text-align: center; padding: 20px 0;">
            <div class="logo">
                <a href="https://cwa.mx" target="_blank" style="display: inline-block;">
                    <img src="images/powered_cwa_red.svg" alt="Powered by CWA" style="width: 250px; height: auto;">
                </a>
            </div>
            <div class="copyright" style="margin-top: 10px; font-size: 0.875em; color: #6c757d;">
